...
export default function SongListEntry({
  ...
  return (
    ...
    <div className="relative grid grid-cols-[1fr_auto] md:grid-cols-[2fr_3fr_12rem] lg:grid-cols-[2fr_3fr_1.5fr_8rem_6rem] items-start gap-x-2 py-2.5 px-2 hover:bg-zinc-50 transition-colors group">
